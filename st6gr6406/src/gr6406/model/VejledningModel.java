...
public class VejledningModel {
    //Attributter
    private StringProperty kostVejledning; 
    private StringProperty fysiskAktivitetVejledning; 
    private StringProperty opskrifter;
    
    
    /**
     * @return the kostVejledning
     */
    public StringProperty getKostVejledning() {
     ...
     */
    public void setKostVejledning(StringProperty kostVejledning) {
     ...
     */
    public StringProperty getFysiskAktivitetVejledning() {
     ...
     */
    public void setFysiskAktivitetVejledning(StringProperty fysiskAktivitetVejledning) {
     ...
     */
    public StringProperty getOpskrifter() {
        return opskrifter;
    }
     ...
     */
    public void setOpskrifter(StringProperty opskrifter) {
